!(function (t, i) {
  ...
  function i(i, a, e) {
    const o = (function (i, a, e, o, s) {
      ...
      const u = new ArrayBuffer(44 + n)
      const r = new DataView(u)
      const d = e
      let h = 0
      return (
        t(r, h, 'RIFF'),
        ...
        (h += 4),
        i.forEach(t => {
          for (let i = new DataView(t.buffer), a = 0; a < t.byteLength; )
  ...
  return (function () {
    ...
    return (
      ...
      (t.prototype.start = function (t) {
        ...
        const e = a.autoPlay
        const o = void 0 === e || e
        const s = a.sampleRate
        const n = void 0 === s ? 16e3 : s
        const u = a.resumePlayDuration
        const r = void 0 === u ? 1e3 : u
        this.reset(), (this.status = 'init'), (this.resumePlayDuration = r)
        const d = n
        let h = Math.max(d, 22050)
        ;(h = Math.min(h, 96e3)),
          ...
          (this.processor.onmessage = function (t) {
            const a = t.data
            const e = a.audioData
            const s = a.pcmAudioData
            i.audioDatas.push(e),
              i.pcmAudioDatas.push(s),
              i.audioDatas.length === 1 && o && i.status === 'init' && i.play()
          })
      }),
      (t.prototype.play = function () {
        ...
        this.audioContext ||
          ...
          this.audioContext &&
            ((this.status = 'play'),
            (t = this.onPlay) === null || void 0 === t || t.call(this),
            this.playAudio())
      }),
      ...
      (t.prototype.getAudioDataBlob = function (t) {
        let a, e
        if (
          (a = this.pcmAudioDatas) === null || void 0 === a ? void 0 : a.length
        )
          return t === 'wav'
